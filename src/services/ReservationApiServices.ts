...
import { QueryParams, Reservation } from "@/interfaces/interfaces";

class ReservationApiService extends EntityApiService<Reservation> {
  ...
  create = (params: Reservation, config: AxiosRequestConfig = {}) => {
...
export default new ReservationApiService("/reservations");
