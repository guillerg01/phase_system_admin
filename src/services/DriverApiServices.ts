...
class DriverApiService extends EntityApiService<Driver> {
  ...
  createRequestMoreDisplay = (
    params: string[],
    config: AxiosRequestConfig = {}
  ) => {
    return this.getApiService()
      .getService()
      .post(this.getPath("/request-more-display/"), params, config);
  };
  createRequestMoreDevices = (
    params: string[],
    config: AxiosRequestConfig = {}
  ) => {
    return this.getApiService()
      .getService()
      .post(this.getPath("/request-more-devices/"), params, config);
  };
...
export default new DriverApiService("/drivers");
