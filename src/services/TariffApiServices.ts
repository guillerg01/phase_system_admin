...
import { Driver, ElectricCarChargingTariff, QueryParams } from "@/interfaces/interfaces";

class TariffApiService extends EntityApiService<ElectricCarChargingTariff> {
  ...
  create = (params: ElectricCarChargingTariff, config: AxiosRequestConfig = {}) => {
    return this.getApiService()
      .getService()
      .post(this.getPath("/register"), params, config);
  };
  history = (id: string, config: AxiosRequestConfig = {}) => {
    return this.getApiService()
      .getService()
      .get(this.getPath("/history/" + id), config);
  };

    update = (id: string, params: ElectricCarChargingTariff, config: AxiosRequestConfig = {}) => {
    return this.getApiService()
      .getService()
...
export default new TariffApiService("/tariffs");
